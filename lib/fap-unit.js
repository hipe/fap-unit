...
FapCasesRunner.prototype = {
  ...
  _announceSummary : function() {
    this.puts(optparse.Color.methods.color('ohai in red', 'dark_red'));
...
FapCase.prototype = {
  ...
  */
  ...
  globalRunDisable : function() {
    FapCase.globalRunEnabled = false;
    return this;
  },
...
exports.testCase = function() {
  ...
  if (arguments.length >= 2) {
    ...
    for (i in FapCase.prototype) { caze[i] = FapCase.prototype[i]; }
  } else {
    caze = new FapCase(arguments[0]);
  }
  return caze;
};
